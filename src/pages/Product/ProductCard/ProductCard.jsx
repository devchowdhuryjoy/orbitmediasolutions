  ...
  return (
    <>
        ...
        {products.map((product) => {
          ...
          return (
            ...
            >
              {/* Image */}
              <img
                src={`https://theorbit.one/${product.product_image}`}
                alt={product.banner_title}
      ...
      <div className="flex justify-center mt-8">
        <Link to="/all-products"><RainbowGradientButton>View All Products</RainbowGradientButton></Link>
      </div>
    </>
  );
};
