...
const BlogHeader = ({ title, subtitle, description, image }) => {
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            {subtitle && (
              <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-4">
                <span className="font-normal block sm:inline">{subtitle}</span>
              </h3>
            )}
            ...
            {description && (
              <div
                ...
                className="inline-flex justify-center md:justify-start cursor-pointer"
              >
          ...
          {image && (
            <div className="flex-1 flex justify-center md:justify-end w-full">
              <img
                src={image}
                alt={title}
                className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl rounded-md shadow-2xl object-cover"
              />
            </div>
          )}
        </div>
