  ...
  return (
    <footer className="bg-white ">
      <div className="container mx-auto px-6 py-12 grid md:grid-cols-3 gap-10">
        {/* Left Side */}
        <div>
          <img src={logo} alt="Orbit Media Solutions" className="w-32 mb-4" />
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 text-gray-700">
            <div className="space-y-2">
              <Link to="/about" className="hover:text-violet-500 block">
                About
              </Link>
              <Link to="/blog" className="hover:text-violet-500 block">
                Blog
              </Link>
              <Link to="/career" className="hover:text-violet-500 block">
                Career
              </Link>
              <Link to="/contact" className="hover:text-violet-500 block">
                Contact
              </Link>
            </div>

            <div className="space-y-2">
              <Link to="/services" className="hover:text-violet-500 block">
                All Services
              </Link>
              <Link to="/products" className="hover:text-violet-500 block">
                All Products
              </Link>
              <Link to="/partner" className="hover:text-violet-500 block">
                Partner
              </Link>
            </div>
          </div>
